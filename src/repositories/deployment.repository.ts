...
export interface IDeploymentRepository {
  ...
  update(id: string, data: Partial<Pick<Deployment, 'status' | 'containerPort' | 'subdomain' | 'buildStep' | 'buildLog' | 'commitHash' | 'servingMethod' | 'startedAt' | 'completedAt'>>): Promise<Deployment>;
...
export class DeploymentRepository implements IDeploymentRepository {
  ...
  async update(
    id: string,
    data: Partial<Pick<Deployment, 'status' | 'containerPort' | 'subdomain' | 'buildStep' | 'buildLog' | 'commitHash' | 'servingMethod' | 'startedAt' | 'completedAt'>>
  ): Promise<Deployment> {
